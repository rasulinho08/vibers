...
React Native
Expo (Expo Router)
Zustand (State Management - Context & Roles)
Lucide React Native (Scalable vector icons)
Getting Started
Prerequisites
Make sure you have Node.js and npm installed. Since this is an Expo project, it is highly recommended to have the Expo Go app installed on your iOS or Android device.
